...
export interface RuleParams {
    ...
    MANAGER_SAME_DAY: { max: number; saturdayCoversThreshold: number };
...
export const BUILTIN_RULES: Omit<SchedulingRuleRecord, 'id' | 'tenantKey'>[] = [
    ...
    },
    {
        ...
        name: 'Max 1 manager per giorno',
        description: 'Non assegnare più manager nello stesso giorno, salvo sabato con molti coperti.',
        enabled: true,
        params: JSON.stringify({ max: 1, saturdayCoversThreshold: 180 } satisfies RuleParams['MANAGER_SAME_DAY']),
        isBuiltin: true,
    },
    {
