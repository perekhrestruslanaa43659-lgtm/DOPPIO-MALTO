...
export const DEFAULT_STATIONS = [
    // Sala
    'Jolly Sala', 'BARGIU', 'BARSU', 'ACCSU',
    'CDR', 'CDR_V', 'CDR_S', 'CDR_D',
    'ACCGIU_V', 'ACCGIU:S', 'ACCGIU:_D',
    'B/S', 'B/S_2', 'B/S_V', 'B/S_S', 'B/S_D',
    'SCARICO', 'PASS',
    // Cucina
    'Jolly Cucina', 'Pira', 'Burger', 'Fritti', 'Dolci/Ins', 'Preparazione',
    'Lavaggio', 'Lavaggio Cappa', 'SCARICO_Cucina', 'Pulizia Sala', 'Pulizia Cucina'
];

// Station classification for role-based filtering
export const SALA_KEYWORDS = [
    'sala', 'bar', 'acc', 'cdr', 'b/s', 'pass', 'accoglienza', 'scarico'
];
